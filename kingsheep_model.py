...
def kingsheep_iteration(i, ks, player1, player2,reason,player1_sheep,player1_wolf,player2_sheep,player2_wolf):
    ...
    if not game_over:
        ...
        # if player1.name == SEARCH_PLAYER:
        # if player1.name in [SEARCH_PLAYER, SEARCH_ULT_PLAYER]:
        if player1.name in ['ULTPlayer']:
    ...
    if not game_over:
        ...
        # if player2.name == SEARCH_PLAYER:
        # if player2.name in [SEARCH_PLAYER, SEARCH_ULT_PLAYER]:
        if player2.name in ['ULTPlayer']:
...
def kingsheep_play(player1class, player2class, map_name):
    ...
    # if ks.name1 != SEARCH_PLAYER:
    # if ks.name1 not in  [SEARCH_PLAYER, SEARCH_ULT_PLAYER]:
    if ks.name1 not in  ['ULTPlayer']:
    ...
    # if ks.name2 != SEARCH_PLAYER:
    # print("ks.name2",ks.name2)
    # if ks.name2 not in [SEARCH_PLAYER, SEARCH_ULT_PLAYER]:
    print(">>>>>>>>>", ks.name2)
    if ks.name2 not in ['ULTPlayer']:
    ...
    if graphics:
        import ksgraphics_model
        ksgraphics_model.init(NO_ITERATIONS, FIELD_WIDTH, FIELD_HEIGHT, ks, player1, player2, debug, verbosity, slowdown,player1_sheep,player1_wolf,player2_sheep,player2_wolf)
...
def main():
    ...
    parser.add_argument("-map", dest="map", help="map file")

    # Search_player = 'JCDPlayer'

    # dest: map
    # map_path_l = u'/Users/jcd/PycharmProjects/MyExercise/uzh_class/Prac_AI/resources/test.map'
    # _map_path = u'resources/grading_1.map'
    # _map_path = u'resources/grading_1_s.map'
    # _map_path = u'resources/grading_2.map'
    # _map_path = u'resources/grading_3.map'
    # _map_path = u'resources/grading_3_s.map'
    # _map_path = u'resources/my_map.map'
    # _map_path = u'resources/my_map_s.map'
    # _map_path = u'resources/my_map_2.map'
    _map_path = u'resources/test.map'
    # _map_path = u'resources/test_s.map'
    # _map_path = u'resources/test_gui.map'
    # _map_path = u'resources/test3.map'

    # _p1m = u'simple_player'
    # _p1n = u'SimplePlayer'
    # SEARCH_PLAYER = 'JCDPlayer'

    ## SEARCH_PLAYER = 'ADVPlayer'
    ## SEARCH_ULT_PLAYER = 'ULTPlayer'

    # _p1m = 'xiason_A2_v1'
    # _p1m = 'xiason_A2_v3_updated'
    # _p1m = 'xiason_A2_v2'
    # _p1n = SEARCH_PLAYER
    _p1m = 'xiason_A2_v4_getModel'
    # _p1n = SEARCH_ULT_PLAYER
    _p1n = 'ULTPlayer_Model_pre'
    _p1m = u'mlp_player'
    _p1n = u'MLPPlayer'
    # _p1m = u'random_player'
    # _p1n = u'RandomPlayer'


    # _p2m = u'myAStar_player_adv'
    # _p2n = u'MyPlayerADV'
    # _p2m = u'xiason_a3'
    # _p2n = u'MLPlayer'
    # _p2m = 'xiason_A2_v1'
    # _p2m = 'xiason_A2_v3_updated'
    # _p2m = 'xiason_A2_v4'
    # _p2n = SEARCH_ULT_PLAYER

    ## _p2m = 'xiason_A2_v2'
    ## _p2n = SEARCH_PLAYER

    _p2m = u'simple_player'
    _p2n = u'SimplePlayer'
    ...
    #  Mar 15: added by JCD
    args.map = _map_path
    args.player1module = _p1m
    args.player1name = _p1n
    args.player2module = _p2m
    args.player2name = _p2n
    args.graphics = _graphics
    args.debug = _debug
    args.verbosity = _verbosity
    args.slowdown = 0
